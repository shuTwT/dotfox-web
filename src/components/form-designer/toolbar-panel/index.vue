  ...
  <div class="toolbar-container">
    <div class="left-toolbar">
      <el-button
        ...
        @click="undoHistory"
      >
        <iconify-icon-online icon="material-symbols:undo"
      /></el-button>
      <el-button
        link
        type="primary"
        ...
        @click="redoHistory"
      >
        <iconify-icon-online icon="material-symbols:redo"
      /></el-button>
      ...
      >
        <iconify-icon-online icon="ri:node-tree"
      /></el-button>
    </div>
    ...
    <div class="right-toolbar" :style="{ width: toolbarWidth + 'px' }">
      <div class="right-toolbar-con">
        ...
        <el-button
          ...
          @click="generateSFC"
        >
          <iconify-icon-online icon="logos:vue" />{{
