  ...
  <div class="container-wrapper" :class="[customClass]">
    ...
    >
      <i :title="i18nt('designer.hint.dragHandler')"
        ><iconify-icon-online icon="ep:drag-move"
      /></i>
      <i>{{
        i18n2t(
      ...
      <i v-if="widget.options.hidden === true"
        ><iconify-icon-online icon="ep:hide"
      /></i>
    </div>
  </div>
</template>
